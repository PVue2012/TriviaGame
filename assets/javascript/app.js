...
var questions = [{
    ...
    answerList: [" Three", "Four", " Two", "One"],
    answer: 0
},{
    question: "Which dinosaur period came first?",
    answerList: [" Cretaceous", " Vietnam War", " Jurassic", " Triassic"],
    answer: 2
},{
    question: "Was Diplodocus a carnivore, herbivore, both, or a vegan?",
    answerList: ["Carnivore", "Herbivore", "Both", "Vegan"],
    answer: 1
},{
    question: "Apatosaurus is also widely known by what other name?",
    answerList: ["Spikey Dino", "Bottom Feeder", "The Distroyer", "Brontosaurus"],
    answer: 3
},{
    question: "What dinosaur weighed more?",
    answerList: [" Deinonychus", "Spinosaurus", "Dilong", "Aquilops"],
    answer: 1
},{
    question: "A person who studies fossils and prehistoric life such as dinosaurs is known as a what?",
    answerList: ["Paleontologist", "Podiatrist", "Anthropologist", "Botanist"],
    answer: 0
},{
    question: "What dinosaur themed book was turned into a blockbuster movie in 1993",
    answerList: ["Goodnight Dinsaur", "My Favorite Dinosaur", "Land Before Time", "Jurassic Park"],
    answer: 3
}];
...
function displayResults() {
    ...
    $("#resultsMessage").html("<h3>How did you do?</h3>");
